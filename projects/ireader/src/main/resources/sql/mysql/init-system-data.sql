...
delete from `sys_position` where id>=1 and id<=1;;
insert into `sys_position`(`id`, `parent_id`, `parent_ids`, weight, `name`, `is_show`) values (1, 0, '0/', 1, '职务', true);;
...
insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `is_show`)
  values (24, 22, '0/1/16/22/', 2, '工作职务列表', 'position', '/admin/sys/organization/position', true);;
insert into `sys_resource`(`id`, `parent_id`, `parent_ids`, weight, `name`, `identity`, `url`, `is_show`)
...
insert into sys_auth (`id`, `organization_id`, `position_id`, `user_id`, `group_id`, `role_ids`, `type`)
